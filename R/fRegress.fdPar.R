fRegress.fd <- function(y, xfdlist, betalist, wt = NULL, y2cMap = NULL, SigmaE
                 = NULL, method, sep = ".", ...){
  yfdPar <- fdPar(y, ...)
  fRegress.fdPar(y, xfdlist, betalist, wt = NULL, y2cMap = NULL, SigmaE
                 = NULL, method, sep = ".", ...)
}
...
#                    function FREGRESSStdERR that computes standard errors
