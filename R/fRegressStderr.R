fRegressStderr <- function(fRegressList, y2cMap, SigmaE, ...) {

#  FREGRESSSTDERR  computes standard error estimates for regression
...
#  Note: earlier version named fRegressStderr.  This name was changed to avoid
#  having this function treated as a method of fRegress.

#  Last modified 10 January 2020 by Jim Ramsay
